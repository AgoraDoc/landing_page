const landingPageData = {
  Voice: {
    cn: {
      desc: "语音通话可以实现纯语音的一对一单聊和多人群聊，所有用户都可发言。通过 Agora RTC SDK，你可以实现语音通话；通过服务端 RESTful API，你可以实现创建项目、获取用量、创建踢人规则等功能。",
      overview: {
        Android: [
          {
        ...
        ReactNative: [
          {
            link: "/cn/Voice/product_voice?platform=ReactNative",
            title: "产品概述",
          },
          {
            link: "/cn/Voice/billing_audio?platform=ReactNative",
            title: "计费说明",
          },
          {
            link: "/cn/Voice/release_react_native_video?platform=ReactNative",
            title: "发版说明",
          },
        ],
        "Cocos Creator": [
      ...
      quickStart: {
        ...
        ReactNative: {
          link:
            "/cn/Voice/start_call_audio_react_native?platform=ReactNative",
          title: "快速开始",
          desc: "快速集成 Agora RTC SDK，实现语音通话功能。",
        },
        "Cocos Creator": {
    ...
    en: {
      ...
      overview: {
        ...
        ReactNative: [
          {
            link: "/en/Voice/product_voice?platform=ReactNative",
            title: "Product Overview",
          },
          {
            link: "/en/Voice/billing_audio?platform=ReactNative",
            title: "Billing",
          },
          {
            link: "/en/Voice/release_react_native_video?platform=ReactNative",
            title: "Release Notes",
          },
        ],
        "Cocos Creator": [
      ...
      quickStart: {
        Android: {
          ...
          title: "Quick start",
          desc: "Use this guide to quickly implement a voice call using the Agora RTC SDK.",
        },
        iOS: {
        ...
        ReactNative: {
          link: "/en/Voice/start_call_audio_react_native?platform=ReactNative",
          title: "Quick start",
          desc: "Use this guide to quickly implement a voice call using the Agora RTC SDK.",
        },
        "Cocos Creator": {
  ...
  "Real-time-Messaging": {
    cn: {
      desc: "Agora 实时消息（Real-time Messaging，RTM）SDK 提供了稳定可靠、低延时、高并发的全球消息云服务，帮助你快速构建实时场景。",
      overview: {
        Android: [
          {
    ...
    en: {
      desc: "You can use the Agora RTM (Real-time Messaging) SDK to create a stable messaging mechanism for real-time messaging scenarios that require low latency and high concurrency for a global audience.",
      overview: {
        Android: [
          {
  ...
  "Agora Analytics": {
    cn: {
      ...
      articles: {
        ...
        ReactNative: [
          {
            link: "/cn/Agora%20Analytics/aa_live_data?platform=ReactNative",
            title: "实时数据",
            desc: "实时查看当前项目的在线规模、质量水平和异常情况等。",
          },
          {
            link: "/cn/Agora%20Analytics/aa_big_channel?platform=ReactNative",
            title: "大频道",
            desc: "实时监控和分析大频道的通话质量。",
          },
          {
            link: "/cn/Agora%20Analytics/aa_realtime_alarm?platform=ReactNative",
            title: "实时预警",
            desc: "实时监控通话体验质量并获取体验异常信息。",
          },
        ],
    ...
    en: {
      ...
      overview: {
        ...
        ReactNative: [
          ...
          {
            link: "/en/Agora%20Analytics/release_aa?platform=ReactNative",
            title: "Release notes",
          },
        ],
        "Cocos Creator": [
      ...
      articles: {
        ...
        ReactNative: [
          {
            link: "/en/Agora%20Analytics/aa_live_data?platform=ReactNative",
            title: "Realtime",
            desc: "This article introduces how to view the real-time scale, quality, and any abnormalities of your project.",
          },
          {
            link: "/en/Agora%20Analytics/aa_big_channel?platform=ReactNative",
            title: "Big Channel",
            desc: "This article introduces how to monitor and analyze quality issues of Big Channels in real time.",
          },
          {
            link: "/en/Agora%20Analytics/aa_realtime_alarm?platform=ReactNative",
            title: "Real-time Alarm",
            desc: "This article introduces how to monitor call quality and user's communication experience.",
          },
        ],
